...
class Conversation extends Connector
{
    ...
    {
        return parent::create_data(get_class(), base_url('texts').get_path('texts', 'conversations'), $token, $params);
    }
    ...
    public static function gets($token, $params = array())
    {
        ...
        return parent::retrive_list(get_class(), base_url('texts').get_path('texts', 'conversations'), $token, $params);
    }
