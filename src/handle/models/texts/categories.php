...
class Category extends Connector
{
    ...
    {
        return parent::create_data(get_class(), base_url('texts').get_path('texts', 'categories'), $token, json_encode($params));
    }
    ...
    public static function gets($token, $params = array())
    {
        ...
        return parent::retrive_list(get_class(), base_url('texts').get_path('texts', 'categories'), $token, json_encode($params));
    }

    public static function find_id($token, $id)
    {
        return parent::retrive_once(get_class(), base_url('texts').get_path('texts', 'categories'), $token, $id, true);
    }
}
