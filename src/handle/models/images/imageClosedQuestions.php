...
class ImageClosedQuestion extends Connector
{
    ...
    {
        return parent::create(get_class(), base_url("images").get_path("images", "closed_questions"), $token, $params);
    }
    ...
    public static function gets($token, $params = array())
    {
        ...
        return parent::retrive(get_class(), base_url("images").get_path("images", "closed_questions"), $token, $params);
    }
