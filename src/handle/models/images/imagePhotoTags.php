...
class ImagePhotoTag extends Connector
{
    ...
    {
        return parent::create(get_class(), base_url("images").get_path("images", "photo_tag"), $token, $params);
    }
    ...
    public static function gets($token, $params = array())
    {
        ...
        return parent::retrive(get_class(), base_url("images").get_path("images", "photo_tag"), $token, $params);
    }
