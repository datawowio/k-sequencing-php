...
class ImageMessage extends Connector
{
    ...
    {
        return parent::create_data(get_class(), base_url('images').get_path('images', 'messages'), $token, $params);
    }
    ...
    public static function gets($token, $params = array())
    {
        ...
        return parent::retrive_list(get_class(), base_url('images').get_path('images', 'messages'), $token, $params);
    }
